...
router.post('/register', createVoterValidation, validate, voterController.createVoter);

// Get all voters
router.get('/', voterController.getAllVoters);

// Get voter by ID
router.get('/voter', getVoterByIdValidation, validate, voterController.getVoterById);

// Get voter profile by wallet address
// router.get('/profile', getVoterByWalletValidation, validate, voterController.getVoterProfile);
...
// Update voter
router.put('/voter', updateVoterValidation, validate, voterController.updateVoter);

// Delete voter
router.delete('/voter', deleteVoterValidation, validate, voterController.deleteVoter);
